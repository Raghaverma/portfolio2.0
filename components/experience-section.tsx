...
const experiences = [
  {
    ...
    highlights: [
      "Contributing to a Trading & Analytics Platform built with Next.js + TypeScript, successfully reducing app loading time by 20-30% through performance optimizations.",
      "Developed Markets, Leaderboard, Wallet pages with responsive UI and API integrations.",
      "Fine-tuned performance and scalability through reusable components and optimized state handling.",
      "Collaborated on a design system ensuring consistency with Figma designs.",
      "Maintained Git branching workflows for smooth team collaboration.",
    ],
  },
  {
